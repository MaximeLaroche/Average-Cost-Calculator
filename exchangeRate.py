...
class BankOfCanadaRate:
    ...
    _DAILY_URL = 'https://www.banqueducanada.ca/valet/observations/group/FX_RATES_DAILY/csv'
    _YEARLY_URL = 'https://www.banqueducanada.ca/valet/observations/group/FX_RATES_ANNUAL/csv'
    ...
    def readFiles(self):
        self.daily = pd.read_csv(BankOfCanadaRate.folder + BankOfCanadaRate._DAILY_FILE_NAME, index_col='date')
        self.yearly = pd.read_csv(BankOfCanadaRate.folder + BankOfCanadaRate._YEARLY_FILE_NAME, index_col='date')
